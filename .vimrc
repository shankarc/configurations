...
"macros
"ifdef SVARC
let @s="/TARGET_IS_SVARCma€kl€kl€kh%dd'add"
"clean header
"let @h="/SVARC:s/SVARC/SBC-CP/Versionf:€krd$A 1.0oI€kb TODO: In€kbNSERTY€kb_LM_COPYRIGHT_HEREomaxxma/COP€kb€kb€kbMOTOROLA€ku€kumb:'a,'bdO"
"let @h="/SVARC:s/SVARC/SBC-CP/Versionf:€krd$A 1.0oI€kb TODO: In€kbNSERTY€kb_LM_COPYRIGHT_HEREomaxxma/COP€kb€kb€kbMOTOROLA€ku€kumb:'a,'bdO@w"
"date expander 06/06/12 in insert mode expands to date
:iab <expr> ddate strftime("%m/%d/%y")
"let @w = "/Revisionf:€krd$A ddate w"
"6/6/12 macro for TARGET IS SBC-CP
"let @t="/TARGET_IS_SBC-CP€ku€kdma€kh%mb'addiif(SBC_C_ID == ard_pv::get_processor_id()){'bddA} //if(SBC_C_ID)"
"font 
...
"let @c=":0/COPYRIGHT €ku€kl€kl€kl€kl€kl€kl€kl€kh€ýLma€kd/-------mb:'a,'bd"
"07/13/12 
"swap dates in Original Date and Revision Date
let @d =":0/Original/:€krd$:0/Revision/:€kry$d$::/Original/:p"
set path=.,/home/Shankar/WindRiver/workspace/dev/sys/include
" 09/20/12 
"[merge]
"tool = vimdiff
